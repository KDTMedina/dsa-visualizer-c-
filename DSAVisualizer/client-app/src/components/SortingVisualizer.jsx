            ...
            <div className="bg-white rounded-xl shadow-lg p-6">
              ...
              <div className="space-y-2 text-sm">
                <div className="flex items-center gap-2">
                  <div className="w-8 h-8 rounded bg-[#01A7C2]"></div>
                  <span>Normal / Comparing</span>
                </div>
                <div className="flex items-center gap-2">
                  <div className="w-8 h-8 rounded bg-[#007090]"></div>
                  <span>Swapping</span>
                </div>
                <div className="flex items-center gap-2">
                  <div className="w-8 h-8 rounded bg-[#006989]"></div>
                  <span>Sorted</span>
                </div>
              </div>
            </div>
